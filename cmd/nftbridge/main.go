...
import (
	...
	"github.com/NftTeam/NftBridge/chains/ethereum"
	"github.com/NftTeam/NftBridge/config"
	"github.com/NftTeamHackaton/bridge-utils/core"
	"github.com/NftTeamHackaton/bridge-utils/metrics/health"
...
var accountCommand = cli.Command{
	...
	Description: "The accounts command is used to manage the bridge keystore.\n" +
		"\tTo generate a new account (key type generated is determined on the flag passed in): nftbridge accounts generate\n" +
		"\tTo import a keystore file: nftbridge accounts import path/to/file\n" +
		"\tTo import a geth keystore file: nftbridge accounts import --ethereum path/to/file\n" +
		"\tTo import a private key file: nftbridge accounts import --privateKey private_key\n" +
		"\tTo list keys: nftbridge accounts list",
...
func init() {
	app.Action = run
	app.Copyright = "Copyright 2022 Nft Hackaton"
	app.Name = "nftbridge"
	app.Usage = "NftTeam"
	app.Authors = []*cli.Author{{Name: "NftTeam 2022"}}
	app.Version = Version
